...
fn test_get_list_of_prime_factors() {
    ...
    let prime_factors = get_list_of_prime_factors(BigUint::from_str_radix("56", 10).expect("Failed to convert string to BigUint"));
...
fn test_get_lowest_prime_factor() {
    ...
    let lowest_prime_factor = get_lowest_prime_factor(BigUint::from_str_radix("56", 10).expect("Failed to convert string to BigUint"));
